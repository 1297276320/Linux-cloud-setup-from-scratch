...
&emsp;&emsp;本教程将介绍如何搭建一台属于自己的**线下高性能主机**，并将其配置成开发环境。整个方案适用于 Linux 系统，只需花费云主机 **约 1% 的价格**，就能获得媲美高性能云主机的开发体验。
...
# 二、硬件选购
本次选用的机架式服务器为 **Dell PowerEdge R730XD**，配置如下：
...
### 1. 服务器选型
R730XD 是2015 年左右发布的企业级机架式服务器，属于2015年 Dell 旗舰 13 代服务器。当年它的定位是大型企业的数据中心、虚拟化、数据库和高性能计算集群，所以售价非常高，一台全新、双路 CPU、满配内存和硬盘的 R730XD，**落地价往往是几万元**到十几万元人民币。而现在一台R730XD**只要200块**！对了，R730系列有很多，目前主流的有5款。
- R730（8个2.5寸硬盘）
- R730（16个2.5寸硬盘）
- R730XD（24个2.5寸硬盘）
- R730XD（12个3.5寸硬盘）
